...
const cases = [
  ...
  },
  {
    ...
    file: '03-product-config-1180x820.png',
    heading: 'X-Bacon',
  },
  {
    name: 'entrega e cliente',
    screen: 'delivery',
    viewport: { width: 1180, height: 820 },
    file: '04-delivery-1180x820.png',
    heading: 'Entrega',
  },
  {
    name: 'seleção de mesa',
    screen: 'table',
    viewport: { width: 1180, height: 820 },
    file: '05-table-1180x820.png',
    heading: 'Escolha a mesa',
  },
  {
    name: 'pagamento',
    screen: 'payment',
    viewport: { width: 1180, height: 820 },
    file: '06-payment-1180x820.png',
    heading: 'Revisar e finalizar',
  },
  {
    name: 'sucesso',
    screen: 'success',
    viewport: { width: 1180, height: 820 },
    file: '07-success-1180x820.png',
    heading: 'Pedido #315 criado',
  },
  {
    name: 'kds',
    screen: 'kds',
    viewport: { width: 1180, height: 820 },
    file: '08-kds-1180x820.png',
    heading: 'Cozinha',
  },
  {
    ...
    file: '09-pos-mobile-390x844.png',
    heading: 'Novo pedido',
  },
] as const;
