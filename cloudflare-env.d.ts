/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 95c59170d0d69fe07d10e07c1a2cb9d6)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		ORDER_EVENTS_WORKER: Fetcher /* pedidolocal-order-events-staging */ | Fetcher /* pedidolocal-order-events-production */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "APP_ENV" | "ORDER_EVENT_PUBLISH_MODE" | "WEB_PUSH_ENABLED" | "MERCHANT_WEB_PUSH_ENABLED">> {}
}
