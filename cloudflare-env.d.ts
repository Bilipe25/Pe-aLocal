/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: aa86aa893488c88ce21557e91eab970e)
// Runtime types generated with workerd@1.20260426.1 2026-05-03 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
  interface StagingEnv {
    NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
    STORE_ASSETS_R2: R2Bucket;
    HYPERDRIVE: Hyperdrive;
    HYPERDRIVE_FRESH: Hyperdrive;
    ORDER_OUTBOX_QUEUE: Queue;
    AUTH_RATE_LIMITER: RateLimit;
    ORDER_RATE_LIMITER: RateLimit;
    PAYMENT_REPORT_RATE_LIMITER: RateLimit;
    CHECKOUT_QUOTE_RATE_LIMITER: RateLimit;
    ORDER_IP_RATE_LIMITER: RateLimit;
    IMAGES: ImagesBinding;
    ASSETS: Fetcher;
    APP_URL: 'https://pedidolocal-staging.gabriellion97.workers.dev';
    APP_ENV: 'staging';
    ORDER_EVENT_PUBLISH_MODE: 'outbox';
    WEB_PUSH_ENABLED: 'true';
    MERCHANT_WEB_PUSH_ENABLED: 'true';
    MERCADO_PAGO_ENABLED: 'true';
    MERCADO_PAGO_CLIENT_ID: '32620436153512';
    MERCADO_PAGO_TEST_APPLICATION_ID: '1828304174612090';
    ...
    WORKER_SELF_REFERENCE: Fetcher /* pedidolocal-staging */;
    ORDER_EVENTS_WORKER: Fetcher /* pedidolocal-order-events-staging */;
  }
  interface ProductionEnv {
    ...
    IMAGES: ImagesBinding;
    ASSETS: Fetcher;
    APP_URL: 'https://pedidolocal-production.gabriellion97.workers.dev';
    APP_ENV: 'production';
    ORDER_EVENT_PUBLISH_MODE: 'direct';
    WEB_PUSH_ENABLED: 'false';
    MERCHANT_WEB_PUSH_ENABLED: 'false';
    MERCADO_PAGO_ENABLED: 'false';
    NEXT_CACHE_DO_QUEUE: DurableObjectNamespace /* DOQueueHandler */;
    NEXT_TAG_CACHE_DO_SHARDED: DurableObjectNamespace /* DOShardedTagCache */;
    WORKER_SELF_REFERENCE: Fetcher /* pedidolocal-production */;
    ORDER_EVENTS_WORKER: Fetcher /* pedidolocal-order-events-production */;
  }
  interface Env {
    NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
    STORE_ASSETS_R2: R2Bucket;
    ...
    ASSETS: Fetcher;
    APP_URL:
      | 'https://pedidolocal-staging.gabriellion97.workers.dev'
      | 'https://pedidolocal-production.gabriellion97.workers.dev';
    APP_ENV: 'staging' | 'production';
    ORDER_EVENT_PUBLISH_MODE: 'outbox' | 'direct';
    WEB_PUSH_ENABLED: 'true' | 'false';
    MERCHANT_WEB_PUSH_ENABLED: 'true' | 'false';
    MERCADO_PAGO_ENABLED: 'true' | 'false';
    MERCADO_PAGO_CLIENT_ID?: '32620436153512';
    MERCADO_PAGO_TEST_APPLICATION_ID?: '1828304174612090';
    MERCADO_PAGO_REDIRECT_URI?: 'https://pedidolocal-staging.gabriellion97.workers.dev/api/integrations/mercado-pago/oauth/callback';
    NEXT_CACHE_DO_QUEUE: DurableObjectNamespace /* DOQueueHandler */;
    NEXT_TAG_CACHE_DO_SHARDED: DurableObjectNamespace /* DOShardedTagCache */;
    WORKER_SELF_REFERENCE: Fetcher /* pedidolocal-staging */ | Fetcher /* pedidolocal-production */;
    ORDER_EVENTS_WORKER:
      | Fetcher /* pedidolocal-order-events-staging */
      | Fetcher /* pedidolocal-order-events-production */;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      ...
      | 'APP_URL'
      | 'APP_ENV'
      | 'ORDER_EVENT_PUBLISH_MODE'
      | 'WEB_PUSH_ENABLED'
      | 'MERCHANT_WEB_PUSH_ENABLED'
