...
export function CancelOrderDialog({ orderNumber, trigger, onConfirm }: CancelOrderDialogProps) {
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <Dialog.Description className="text-text-secondary mt-2 text-sm">
                O pedido será encerrado. Pagamentos pendentes também serão cancelados; pedidos pagos
                exigem reembolso antes desta ação.
              </Dialog.Description>
            </div>
