...
export const Permission = {
  ...
  VIEW_STOREFRONT_DISPLAY: 'VIEW_STOREFRONT_DISPLAY',
  EDIT_STOREFRONT_DISPLAY: 'EDIT_STOREFRONT_DISPLAY',
  ...
  VIEW_DINING_TABLES: 'VIEW_DINING_TABLES',
  ...
  MANAGE_POS_SHORTCUTS: 'MANAGE_POS_SHORTCUTS',
  MANAGE_POS_TERMINALS: 'MANAGE_POS_TERMINALS',
  APPLY_POS_MANUAL_DISCOUNT: 'APPLY_POS_MANUAL_DISCOUNT',
