    ...
    <form action={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
          <span className="shrink-0 text-sm text-text-secondary">pedidolocal.com.br/</span>
          <Input id="slug" name="slug" defaultValue={store.slug} required className="flex-1" />
        </div>
        <p className="text-sm text-text-secondary">Este é o link público do seu cardápio. Use letras minúsculas, números e hífens.</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="space-y-2">
          ...
          <Input id="phone" name="phone" type="tel" inputMode="tel" autoComplete="tel" defaultValue={store.phone ?? ''} placeholder="(11) 99999-9999" />
        </div>
        <div className="space-y-2">
          <Label htmlFor="whatsapp">WhatsApp</Label>
          <Input id="whatsapp" name="whatsapp" type="tel" inputMode="tel" defaultValue={store.whatsapp ?? ''} placeholder="(11) 99999-9999" />
        </div>
      </div>
